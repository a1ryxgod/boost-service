...
export const metadata: Metadata = {
  title: 'Dota 2 Coaching | Learn from Professional Players',
  description: 'Improve your Dota 2 skills with personalized coaching from top-tier players.',
};
...
const plans = [
  ...
  },
  {
    title: '3 Hours',
    price: 64.99,
    features: ['In-depth replay analysis', 'Hero & role guidance', 'Personalized game plan', 'Priority scheduling'],
    popular: true,
  },
  {
    title: '5 Hours',
    price: 99.99,
    features: ['Full gameplay overhaul', 'Advanced mechanics training', 'Draft & itemization coaching', 'Ongoing support via chat', 'Progress tracking'],
  },
];

export default function Dota2CoachingPage() {
  return (
    <div className="service">
      <div className="service__container">
        <div className="service__header">
          <h1 className="service__title">Dota 2 Coaching</h1>
          <p className="service__description">
            One-on-one sessions with Immortal-ranked players. Get personalized advice, replay analysis, and actionable tips to improve your gameplay.
          </p>
        </div>

        <CoachingPlans gameCode={GameCode.DOTA2} plans={plans} />
        ...
        <section className="service__how-it-works">
          ...
          <div className="service__steps">
            ...
            <div className="service__step">
              ...
              <h3 className="service__step-title">Climb MMR</h3>

...
export const metadata: Metadata = {
  title: 'Dota 2 Win Boosting | Fast & Secure Net Wins',
  description:
    'Purchase Dota 2 wins, played by professional boosters. Secure, fast, and reliable service to improve your stats.',
};

export default function Dota2WinBoostPage() {
  return (
        ...
        <section className="service__how-it-works">
          ...
          <div className="service__steps">
            ...
            <div className="service__step">
              ...
              <p className="service__step-description">An experienced Dota 2 player starts playing on your account.</p>
            </div>
            <div className="service__step">

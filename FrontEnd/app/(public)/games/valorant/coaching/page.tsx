...
export const metadata: Metadata = {
  ...
  description: 'Improve your Valorant skills with personalized coaching from top-tier players.',
};
...
const plans = [
  ...
  },
  {
    title: '3 Hours',
    price: 64.99,
    features: ['In-depth replay analysis', 'Agent selection & abilities', 'Personalized game plan', 'Priority scheduling'],
    popular: true,
  },
  {
    title: '5 Hours',
    price: 99.99,
    features: ['Full gameplay overhaul', 'Advanced aim training', 'Map control & rotations', 'Ongoing support via chat', 'Progress tracking'],
  },
];

export default function ValorantCoachingPage() {
  return (
    <div className="service">
      <div className="service__container">
        <div className="service__header">
          <h1 className="service__title">Valorant Coaching</h1>
          <p className="service__description">
            One-on-one sessions with Radiant-ranked players. Get personalized advice, replay analysis, and actionable tips to improve your gameplay.
          </p>
        </div>

        <CoachingPlans gameCode={GameCode.VALORANT} plans={plans} />

...
export const metadata: Metadata = {
  title: 'Valorant Win Boosting | Fast & Secure Net Wins',
  description:
    'Purchase Valorant wins, played by professional boosters. Secure, fast, and reliable service to improve your stats.',
};

export default function ValorantWinBoostPage() {
  return (
        ...
        <section className="service__how-it-works">
          ...
          <div className="service__steps">
            ...
            <div className="service__step">
              ...
              <p className="service__step-description">An experienced Valorant player starts playing on your account.</p>
            </div>
            <div className="service__step">

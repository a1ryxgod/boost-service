...
const plans = [
  ...
  },
  {
    title: '3 Hours',
    price: 64.99,
    features: ['In-depth replay analysis', 'Role & strategy guidance', 'Personalized game plan', 'Priority scheduling'],
    popular: true,
  },
  {
    title: '5 Hours',
    price: 99.99,
    features: ['Full gameplay overhaul', 'Advanced mechanics training', 'Strategic coaching', 'Ongoing support via chat', 'Progress tracking'],
  },
];
    ...
    <div className="service">
      <div className="service__container">
        <div className="service__header">
          <h1 className="service__title">Game Coaching</h1>
          <p className="service__description">
            One-on-one sessions with professional players. Get personalized advice, replay analysis, and actionable tips to improve your gameplay.
          </p>
        </div>

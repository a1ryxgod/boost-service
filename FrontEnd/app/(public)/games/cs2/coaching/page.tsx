...
export const metadata: Metadata = {
  ...
  description: 'Improve your CS2 skills with personalized coaching from top-tier players.',
};
...
const plans = [
  ...
  },
  {
    title: '3 Hours',
    price: 64.99,
    features: ['In-depth replay analysis', 'Map knowledge & positioning', 'Personalized game plan', 'Priority scheduling'],
    popular: true,
  },
  {
    title: '5 Hours',
    price: 99.99,
    features: ['Full gameplay overhaul', 'Advanced aim training', 'Utility usage & tactics', 'Ongoing support via chat', 'Progress tracking'],
  },
];
    ...
    <div className="service">
      <div className="service__container">
        <div className="service__header">
          <h1 className="service__title">CS2 Coaching</h1>
          <p className="service__description">
            One-on-one sessions with professional CS2 players. Get personalized advice, replay analysis, and actionable tips to improve your gameplay.
          </p>
        </div>

        <CoachingPlans gameCode={GameCode.CS2} plans={plans} />

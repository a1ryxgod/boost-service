...
export default function CS2PlacementsBoostPage() {
  return (
      ...
      <div className="service__container">
        <div className="service__header">
          ...
          <p className="service__description">
            Start the season with a strong advantage. Our pro CS2 players will play your placement matches to aim for the best possible start.
          </p>
        </div>
        ...
        <section className="service__how-it-works">
          ...
          <div className="service__steps">
            <div className="service__step">
              ...
              <p className="service__step-description">Choose the number of CS2 placement games you need played.</p>
            </div>
            <div className="service__step">
            ...
            <div className="service__step">
              ...
              <p className="service__step-description">A top-tier CS2 player starts on your placement matches.</p>
            </div>
            <div className="service__step">
              <div className="service__step-number">4</div>
              <h3 className="service__step-title">Get Your Rank</h3>
              <p className="service__step-description">We notify you once done. Discover your new starting CS2 rank!</p>
            </div>
          </div>
        </section>

...
import { CS2_WINS } from '@/features/boost/config/cs2';
...
export default function CS2WinBoostPage() {
  return (
    <div className="service">
      <div className="service__container">
        ...
        <WinsBoostCalculator config={CS2_WINS} />
        ...
        <section className="service__how-it-works">
          ...
          <div className="service__steps">
            ...
            <div className="service__step">
              ...
              <p className="service__step-description">An experienced CS2 player starts playing on your account.</p>
            </div>
            <div className="service__step">
